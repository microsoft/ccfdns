...
def main():
    ...
    targs.node_addresses = [
        (
            ...
            "ns1.acidns.attested.name",  # public name
            "172.167.8.249", # public IP
        )
    ]
    ...
    targs.adns = aDNSConfig(
        origin="acidns.attested.name.",
        service_name="acidns.attested.name.",
        node_addresses={},
        soa=str(
            SOA.SOA(
                rdc.IN,
                rdt.SOA,
                mname="ns1.acidns.attested.name.",
                rname="some-dev.acidns.attested.name.",
                serial=8,
                refresh=604800,
                retry=21600,
                expire=2419200,
